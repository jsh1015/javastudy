 ...
 * 2. dept_seoul 테이블에
 * 	  deptno : 50, dname : 특수영업부, loc : 서울 레코드 추가
 * 3. dept_seoul 테이블에
...
public class Exam01 {
	public static void main(String[] args) throws ClassNotFoundException, SQLException {
		...
		sql = "insert into dept_seoul (deptno, dname, loc) value (50,'특수영업부','서울')";
		...
		while(rs.next()) {
			System.out.print("번호 : " + rs.getString("deptno"));
			System.out.print(", 부서 : " + rs.getString("dname"));
